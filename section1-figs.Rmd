...
#### Correlation between serum iron biomarkers

```{r, results='markup', echo=TRUE}

# NOTE: use the derived variables

# covariance matrix
sub.dat = df3[iron.vars]
cor1 = cor(sub.dat, use="complete.obs")
cor1
...
```{r}
chart.Correlation(sub.dat, histogram=TRUE, pch=19)
```
...
```{r}
chart.Correlation(log(sub.dat), histogram=TRUE, pch=19)
```
