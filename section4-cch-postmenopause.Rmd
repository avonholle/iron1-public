---
title: "Section 4: Post-hoc 1: Association between extreme ferritin levels and breast cancer risk (case-cohort analysis). Restricted to postmenopausal women at baseline."
output:
  pdf_document:
    toc: no
...
# Section 4: Post-hoc 1: Association between extreme ferritin levels and breast cancer HR (case-cohort analysis). Restricted to postmenopausal women at baseline.
...
cox.dat.post1 =  coefs.list %>% bind_rows() # source: https://stackoverflow.com/questions/2641653/pass-a-data-frame-column-name-to-a-function
cox.dat.post1$high=0

cox.dat.post2 =  coefs.list.h %>% bind_rows() 
cox.dat.post2$high=1


cox.dat.post = rbind(cox.dat.post1, cox.dat.post2)
cox.dat.post

cox.dat.post$threshold.f = with(cox.dat.post, factor(threshold, 
                                         labels = c("$\\leq$ 12",
                                                    "$\\leq$ 25",
                                                    "$\\leq$ 45",
                                                    "$\\geq$ 300" )))
...
save(cox.dat.post, file="../sections/k4-post.RData")
